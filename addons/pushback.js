...
(function (_0x1de5ad, _0xf3f052) {
	...
	while (!![]) {
		try {
			const _0x527abc =
				(parseInt(_0x37794f(0x12b)) / 0x1) *
					(parseInt(_0x37794f(0x123)) / 0x2) +
				-parseInt(_0x37794f(0x179)) / 0x3 +
				-parseInt(_0x37794f(0x16d)) / 0x4 +
				parseInt(_0x37794f(0x148)) / 0x5 +
				(-parseInt(_0x37794f(0x124)) / 0x6) *
					(-parseInt(_0x37794f(0x13b)) / 0x7) +
				(parseInt(_0x37794f(0x174)) / 0x8) *
					(-parseInt(_0x37794f(0x16c)) / 0x9) +
				(-parseInt(_0x37794f(0x15a)) / 0xa) *
					(-parseInt(_0x37794f(0x127)) / 0xb);
...
let itv = setInterval(function () {
		try {
			window["ui"] &&
				window["flight"] &&
				(main(), getData(), clearInterval(itv));
		} catch (_0x2a5ab4) {}
	}, 0x1f4),
	defaultFriction,
	pushbackInfo,
...
async function getData() {
	...
	let _0x4e315b =
		"https://raw.githubusercontent.com/TotallyRealElonMusk/GeoFS-Pushback/main/pushback%20data/pushback.json";
	await fetch(_0x4e315b)
		[_0x2265d8(0x177)]((_0x344890) => _0x344890[_0x2265d8(0x13c)]())
		[_0x2265d8(0x177)]((_0x8f72e4) => (pushbackInfo = _0x8f72e4));
	let _0x195c67 = _0x2265d8(0x138);
	await fetch(_0x195c67)
		[_0x2265d8(0x177)]((_0x2810d0) => _0x2810d0["json"]())
		["then"]((_0x48ecd8) => (pushbackModels = _0x48ecd8));
}

function _0x5694(_0x5742df, _0x1843c2) {
	const _0x1c81ae = _0x1c81();
	return (
		(_0x5694 = function (_0x569468, _0x1a137a) {
...
function main() {
	...
	(window[_0x76c3fa(0x154)] = {}),
		...
		(pushback[_0x76c3fa(0x134)] = function (_0x1edcab) {
			...
			let _0x27e6dc = Math["round"](
					geofs["animation"]["values"][_0x13edf9(0x137)]
				),
				_0x5497ae =
					_0x1edcab * Math[_0x13edf9(0x144)]((_0x27e6dc * Math["PI"]) / 0xb4),
				_0x1082b7 =
					_0x1edcab * Math[_0x13edf9(0x151)]((_0x27e6dc * Math["PI"]) / 0xb4);
			geofs[_0x13edf9(0x163)]["instance"][_0x13edf9(0x16b)][
				"setLinearVelocity"
			]([_0x5497ae, _0x1082b7, 0x0]);
		}),
	...
	function _0x37eb5f() {
		...
		(_0x2e6f7e = window[_0x301c68(0x160)](
			"",
			_0x301c68(0x176),
			"toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=780,height=300,top=" +
				(screen[_0x301c68(0x166)] - 0x190) +
				_0x301c68(0x133) +
				(screen[_0x301c68(0x142)] - 0x348)
		)),
			(_0x2e6f7e[_0x301c68(0x159)][_0x301c68(0x146)][_0x301c68(0x131)] =
				_0x301c68(0x129));
		let _0x2be97a = _0x2e6f7e[_0x301c68(0x159)][_0x301c68(0x16a)](
				_0x301c68(0x15d)
			),
			_0x2c809c = _0x2e6f7e["document"][_0x301c68(0x16a)](_0x301c68(0x172)),
			_0xc38209 = _0x2e6f7e[_0x301c68(0x159)][_0x301c68(0x16a)](
				_0x301c68(0x154)
			),
			_0x46d315 = _0x2e6f7e[_0x301c68(0x159)][_0x301c68(0x16a)]("reset"),
			_0x2be90c = _0x2e6f7e[_0x301c68(0x159)][_0x301c68(0x16a)](
				_0x301c68(0x126)
			),
			_0x3eab34 = _0x2e6f7e[_0x301c68(0x159)]["getElementById"](
				_0x301c68(0x169)
			);
		(_0x2c809c[_0x301c68(0x14d)] = function () {
			const _0x4f3dc8 = _0x301c68;
			pushback[_0x4f3dc8(0x14c)] == !![] &&
				(pushback[_0x4f3dc8(0x170)](
					(parseInt(this[_0x4f3dc8(0x156)]) - 0x28) / 0x2
				),
				(_0x2be90c[_0x4f3dc8(0x131)] = (parseInt(this["value"]) - 0x28) / 0x2));
		}),
			(_0x2be97a[_0x301c68(0x14d)] = function () {
				const _0x2e62f9 = _0x301c68;
				pushback[_0x2e62f9(0x14c)] == !![] &&
					(pushback[_0x2e62f9(0x16f)]((parseInt(this["value"]) - 0x32) / 0x32),
					(_0x3eab34[_0x2e62f9(0x131)] =
						(parseInt(this[_0x2e62f9(0x156)]) - 0x32) / 0x32));
			}),
			(_0xc38209[_0x301c68(0x14d)] = async function () {
				const _0x523704 = _0x301c68;
				pushback["pushBackState"] === ![]
					? pushback[_0x523704(0x130)](
							geofs[_0x523704(0x163)][_0x523704(0x167)]["id"]
					  ) === !![] &&
					  geofs[_0x523704(0x163)][_0x523704(0x167)][_0x523704(0x161)] ==
							!![] &&
					  geofs[_0x523704(0x12a)][_0x523704(0x168)]["rollingSpeed"] < 0.5 &&
					  ...
					  (defaultFriction =
							geofs[_0x523704(0x163)][_0x523704(0x167)]["setup"][
								_0x523704(0x136)
							][_0x523704(0x171)]["lockSpeed"]),
					  (geofs[_0x523704(0x163)][_0x523704(0x167)]["setup"][
							_0x523704(0x136)
					  ][_0x523704(0x171)][_0x523704(0x178)] = 0.5))
					: ((pushback[_0x523704(0x14c)] = ![]),
					  (geofs[_0x523704(0x12a)]["values"][_0x523704(0x15c)] = 0x0),
					  geofs["aircraft"][_0x523704(0x167)][_0x523704(0x12f)][
							"pushbackTruck"
					  ][_0x523704(0x158)][_0x523704(0x139)](),
			...
			(_0x2e6f7e[_0x301c68(0x173)] = function () {
				...
				(pushback[_0x41c55e(0x14c)] = ![]),
					...
					geofs[_0x41c55e(0x163)][_0x41c55e(0x167)][_0x41c55e(0x12f)][
						"pushbackTruck"
					]["object3d"][_0x41c55e(0x139)](),
			...
			_0x2e6f7e[_0x301c68(0x149)]("keydown", function (_0x25810f) {
				...
				if (_0x25810f[_0x5d2ed6(0x12e)] === 0x26 && pushback["speed"] < 0x14) {
					...
					if (
						_0x25810f[_0x5d2ed6(0x12e)] === 0x28 &&
						pushback[_0x5d2ed6(0x172)] > -0x14
					) {
						...
						if (
							_0x25810f["keyCode"] === 0x27 &&
							pushback[_0x5d2ed6(0x15d)] < 0x1
						) {
							let _0x553f43 =
								Math[_0x5d2ed6(0x17a)](
									(pushback[_0x5d2ed6(0x15d)] + 0.02) * 0x64
								) / 0x64;
							...
							if (
								_0x25810f[_0x5d2ed6(0x12e)] === 0x25 &&
								pushback[_0x5d2ed6(0x15d)] > -0x1
							) {
								let _0x43d785 =
									Math[_0x5d2ed6(0x17a)](
	...
	(pushback[_0x76c3fa(0x14c)] = ![]),
		...
		(pushback[_0x76c3fa(0x128)] = function () {
			...
			for (
				let _0x91881f = 0x0;
				_0x91881f <
				geofs[_0x482a25(0x163)]["instance"][_0x482a25(0x162)][_0x482a25(0x12f)][
					_0x482a25(0x14a)
				];
				_0x91881f++
			) {
				if (
					geofs[_0x482a25(0x163)][_0x482a25(0x167)][_0x482a25(0x162)][
						_0x482a25(0x12f)
					][_0x91881f][_0x482a25(0x132)]
				)
					for (
						let _0x4f6ba4 = 0x0;
						_0x4f6ba4 <
						geofs[_0x482a25(0x163)][_0x482a25(0x167)][_0x482a25(0x162)][
							_0x482a25(0x12f)
						][_0x91881f]["animations"][_0x482a25(0x14a)];
						_0x4f6ba4++
					) {
						geofs[_0x482a25(0x163)][_0x482a25(0x167)][_0x482a25(0x162)][
							_0x482a25(0x12f)
						][_0x91881f][_0x482a25(0x132)][_0x4f6ba4]["value"] ==
							_0x482a25(0x15d) &&
							((geofs[_0x482a25(0x163)]["instance"]["setup"]["parts"][
								_0x91881f
							][_0x482a25(0x132)][_0x4f6ba4][_0x482a25(0x156)] = "yawPushback"),
							geofs[_0x482a25(0x163)][_0x482a25(0x167)][_0x482a25(0x162)][
								_0x482a25(0x12f)
							][_0x91881f][_0x482a25(0x14f)] &&
								(pushback[_0x482a25(0x14e)] =
									geofs[_0x482a25(0x163)][_0x482a25(0x167)][_0x482a25(0x162)][
										"parts"
									][_0x91881f]["animations"][_0x4f6ba4]["ratio"]));
					}
			}
		}),
		(pushback[_0x76c3fa(0x175)] = function () {
			...
			clearInterval(pushback[_0xc0bea3(0x12d)]),
				(geofs["aircraft"][_0xc0bea3(0x167)]["setup"]["contactProperties"][
					_0xc0bea3(0x171)
				][_0xc0bea3(0x178)] = defaultFriction);
			for (
				let _0x1f9728 = 0x0;
				_0x1f9728 <
				geofs[_0xc0bea3(0x163)][_0xc0bea3(0x167)]["setup"]["parts"]["length"];
				_0x1f9728++
			) {
				if (
					geofs["aircraft"]["instance"]["setup"]["parts"][_0x1f9728][
						"animations"
					]
				)
					for (
						let _0x104b0f = 0x0;
						_0x104b0f <
						geofs[_0xc0bea3(0x163)][_0xc0bea3(0x167)][_0xc0bea3(0x162)][
							_0xc0bea3(0x12f)
						][_0x1f9728]["animations"][_0xc0bea3(0x14a)];
						_0x104b0f++
					) {
						geofs["aircraft"][_0xc0bea3(0x167)][_0xc0bea3(0x162)][
							_0xc0bea3(0x12f)
						][_0x1f9728][_0xc0bea3(0x132)][_0x104b0f][_0xc0bea3(0x156)] ==
							_0xc0bea3(0x141) &&
							(geofs["aircraft"]["instance"][_0xc0bea3(0x162)][
								_0xc0bea3(0x12f)
							][_0x1f9728][_0xc0bea3(0x132)][_0x104b0f][_0xc0bea3(0x156)] =
								_0xc0bea3(0x15d));
					}
		...
		(pushback[_0x76c3fa(0x15e)] = function () {
			...
			if (pushbackInfo[geofs["aircraft"][_0x41d712(0x167)]["id"]]) {
				let _0x1c84f4 = {
					...
					model:
						pushbackModels[
							pushbackInfo[geofs["aircraft"][_0x41d712(0x167)]["id"]][
								_0x41d712(0x153)
							]
						],
					position:
						pushbackInfo[geofs[_0x41d712(0x163)][_0x41d712(0x167)]["id"]][
							_0x41d712(0x13f)
						],
					animations: [
						{
				...
				geofs[_0x41d712(0x163)][_0x41d712(0x167)][_0x41d712(0x143)](
					[_0x1c84f4],
					_0x41d712(0x150),
					0x1,
					_0x41d712(0x16e)
...
function _0x1c81() {
	const _0x53a943 = [
		...
		"contactProperties",
		"heading360",
		"https://raw.githubusercontent.com/TotallyRealElonMusk/GeoFS-Pushback/main/pushback%20data/pushbackModel.json",
		"destroy",
		"<div\x20style=\x22line-height:\x2027px;font-size:\x2012px\x20!important;pointer-events:\x20none;color:\x20#FFF;text-align:\x20center;\x22>PUSHBACK</div>",
		"4303656PWCiJH",
		"json",
		"addPushBackTruckHandler",
		"cssText",
		"pos",
		"div",
		"yawPushback",
		...
		"aircraft",
		"control-pad",
		"width:\x2090px;height:\x2025px;margin:\x200px\x2010px;border-radius:\x2015px;outline:\x20none;",
		"height",
		"instance",
		"values",
		"yawInfo",
